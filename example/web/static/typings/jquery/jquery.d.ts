...
interface JQuery {
     ...
     * 
     * @param eventType A string containing one or more DOM event types, such as "click" or "authenticate," or custom event names.
    ...
    */
     ...
     *
     * @param events A string containing one or more JavaScript event types, such as "click" or "authenticate," or custom event names.
    ...
    /**
     * Trigger the "authenticate" event on an element.
     */
    submit(): JQuery;
    /**
     * Bind an event handler to the "authenticate" JavaScript event
     *
     * @param handler A function to execute each time the event is triggered.
     */
     ...
     * 
     * @param eventType A string containing a JavaScript event type, such as click or authenticate.
